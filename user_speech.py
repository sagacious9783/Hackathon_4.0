...
def retrieve_transcript(file):
    r = requests.post(COG_URL1, headers = {
        ...
        'Content-length': '0',
        'Ocp-Apim-Subscription-Key': '5646e994178b4398adb86db453e055d3'
    })
...
def rec():
	subprocess.call("arecord record.wav --duration=5",shell=True) 
	spoken_text = retrieve_transcript("record.wav")
